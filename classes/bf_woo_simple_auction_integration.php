...
class bf_woo_simple_auction_integration {
	...
	public function buddyforms_simple_auctions_add_wc_form_element_tab( $form_fields, $field_type, $field_id ) {
		...
		$form_fields['Auctions']['_auction_item_condition'] = new Element_Select(
			'<b>' . __( 'Item Condition', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][_auction_item_condition]',
			array(
		...
		$form_fields['Auctions']['_auction_type'] = new Element_Select(
			'<b>' . __( 'Auction Type', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][_auction_type]',
			array(
				'display' => __( 'Display', 'buddyforms' ),
		...
		$form_fields['Auctions']['_auction_proxy'] = new Element_Select(
			'<b>' . __( 'Auction Proxy', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][_auction_proxy]',
			array(
				'display' => __( 'Display', 'buddyforms' ),
		...
		$form_fields['Auctions']['_auction_start_price'] = new Element_Select(
			'<b>' . __( 'Start Price', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][_auction_start_price]',
			array(
		...
		$form_fields['Auctions']['_auction_bid_increment'] = new Element_Select(
			'<b>' . __( 'Bid increment', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][_auction_bid_increment]',
			array(
				'none'     => __( 'None', 'buddyforms' ),
				'required' => __( 'Required', 'buddyforms' ),
				'hidden'   => __( 'Hidden', 'buddyforms' ),
		...
		$form_fields['Auctions']['_auction_reserved_price'] = new Element_Select(
			'<b>' . __( 'Reserve price', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][_auction_reserved_price]',
			array(
				'none'     => __( 'None', 'buddyforms' ),
				'required' => __( 'Required', 'buddyforms' ),
				'hidden'   => __( 'Hidden', 'buddyforms' ),
		...
		$form_fields['Auctions']['_regular_price'] = new Element_Select(
			'<b>' . __( 'Buy it now price', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][_regular_price]',
			array(
				'none'     => __( 'None', 'buddyforms' ),
				'required' => __( 'Required', 'buddyforms' ),
				'hidden'   => __( 'Hidden', 'buddyforms' ),
