...
class bf_woo_simple_auction_requirements {
	
	public function __construct() {
		require_once BF_WOO_SIMPLE_AUCTION_CLASSES_PATH . 'includes/tgm/class-tgm-plugin-activation.php';
	...
	public static function is_woocommerce_simple_auction_active() {
		...
		return ( is_plugin_active( 'woocommerce-simple-auctions/woocommerce-simple-auctions.php' ) );
	}
	...
	public function setup_and_check() {
		...
		$config = array(
			'id'           => 'bf_wc_simple_auction',
			'menu'         => 'bf_wc_simple_auction-install-plugins', // Menu slug.
